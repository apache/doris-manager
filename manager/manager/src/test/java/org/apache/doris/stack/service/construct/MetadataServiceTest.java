...
public class MetadataServiceTest {
    ...
    public void getDatabaseListByNsTest() {
        ...
        try {
            ...
            List<Map<String, Object>> result = metadataService.getDatabaseListByNs(ns, user);
    ...
    public void getDatabaseInfoTest() {
        ...
        try {
            when(clusterUserComponent.getUserCurrentClusterAndCheckAdmin(user)).thenReturn(clusterInfo);
            DatabaseResp result = metadataService.getDatabaseInfo(-1, user);
        ...
        try {
            ...
            DatabaseResp result = metadataService.getDatabaseInfo(dbId, user);
    ...
    public void getTableListByDbTest() {
        ...
        try {
            when(clusterUserComponent.getUserCurrentClusterAndCheckAdmin(user)).thenReturn(clusterInfo);
            List<Map<String, Object>> result = metadataService.getTableListByDb(-1, user);
        ...
        try {
            when(clusterUserComponent.getUserCurrentClusterAndCheckAdmin(user)).thenReturn(clusterInfo);
            List<Map<String, Object>> result = metadataService.getTableListByDb(dbId, user);
    ...
    public void getTableInfoTest() {
        ...
        try {
            when(clusterUserComponent.getUserCurrentClusterAndCheckAdmin(user)).thenReturn(clusterInfo);
            TableResp result = metadataService.getTableInfo(-1, user);
        ...
        try {
            when(clusterUserComponent.getUserCurrentClusterAndCheckAdmin(user)).thenReturn(clusterInfo);
            when(databuildComponent.checkClusterDatabase(dbId, clusterId)).thenReturn(database);
            TableResp result = metadataService.getTableInfo(tableId, user);
    ...
    public void getTableSchemaAndFieldListTest() {
        ...
        try {
            ...
            TableSchemaInfo.TableSchema result = metadataService.getTableSchema(-1, user);
            Assert.assertEquals(result.getSchema().size(), tableSchema.getSchema().size());

            List<String> fieldList = metadataService.getFieldListByTable(-1, user);
        ...
        try {
            when(clusterUserComponent.getUserCurrentClusterAndCheckAdmin(user)).thenReturn(clusterInfo);
            TableSchemaInfo.TableSchema result = metadataService.getTableSchema(tableId, user);
            Assert.assertEquals(result.getSchema().size(), fieldEntities.size());

            List<String> fieldList = metadataService.getFieldListByTable(tableId, user);
