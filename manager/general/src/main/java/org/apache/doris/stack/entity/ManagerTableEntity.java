...
public class ManagerTableEntity {
    ...
    public ManagerTableEntity(int dbId, String name, String description, boolean isBaseIndex, String keyType) {
        this.name = name;
    ...
    public ManagerTableEntity(int dbId, String name, String description) {
        this.name = name;
        this.description = description;
        this.dbId = dbId;
